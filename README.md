...
### Key Contributions
- Implemented frontend A/B experiments and designs based on stakeholder requirements and mockups utiilizing Figma
...
- CSS
- JavaScript
- Experimentation workflows (Adobe Target)
- Cross-browser production support
- DOM manipulation
- Live debugging
- UI consistency
